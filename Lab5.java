...
// FILENAME: Lab5.java
// SPECIFICATION: A program that builds different shapes based off of user input
// FOR: CSE 110 / LAB 5
...
public class Lab5 {
    ...
    private static String buildDiamond(
        ...
        for(int numStars = 1; numStars <= numSymbols - 2; numStars += 2 ) {
        	int numDashes = (totalSymbOneRow - numStars) / 2;
        	
        	String row = buildRow(sideSymb, numDashes, midSymb, numStars);
        	result += row + "\n";
        	}
